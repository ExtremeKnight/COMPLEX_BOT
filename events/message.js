...
module.exports = (client, message) => {
    ...
    if(client.config.debugMode != true){
      try {
        ...
        console.log(`\x1b[41mERROR\x1b[40m \x1b[31mAn unknown error occurred when running this command, please contact Complex's support team, with the error code \x1b[36mZ${client.command}00\x1b[31m.\u001b[0m`)
      }    
    }
    else{
      cmd.run(client, message, args)
