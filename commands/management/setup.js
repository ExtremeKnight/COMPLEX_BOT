...
exports.run = async (client, message, args) => {
    ...
    let ownerOnly = new Discord.MessageEmbed()
        .setAuthor("Complex Setup","https://cdn.discordapp.com/attachments/632238663094370366/632916675808854026/profile.png")
        .setColor(`#FF0062`)
    ...
    let setUp = new Discord.MessageEmbed()
        .setAuthor("Complex Setup","https://cdn.discordapp.com/attachments/632238663094370366/632916675808854026/profile.png")
        .setColor(`#FF0062`)
        .setTitle(`Thanks for purchasing Complex`)
        .setDescription(`Make sure to checkout the [setup guide](https://github.com/Craftymatt2/Complex/wiki/Setup) to see what I create/remove!`)
        .setFooter(`© Complex | Owned by NASH | Developed by NASH\n${client.config.serverName} Utilities ➤ Command ran by ${message.author.username}`,"https://cdn.discordapp.com/attachments/632238663094370366/632916675808854026/profile.png")
