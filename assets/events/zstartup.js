...
module.exports = {
    ...
    securityevent: function(client, guild){
      if(client.config.setup.serverID !== guild.id) {
        guild.leave()
        console.log(`\x1b[41mSECURITY\x1b[40m \x1b[31mWe detected that someone tried to invite your bot to another server (${guild.id}), so Complex automatically left it.\u001b[0m`)
        console.log(`\x1b[41mSECURITY\x1b[40m \x1b[31mYou may need to restart the bot to ensure Complex has left unauthorised servers and the bot runs smoothly again.\u001b[0m`)
        console.log(`\x1b[41mSECURITY\x1b[40m \x1b[31mThere are probably errors below this notice, restart the bot and Complex will run fine again.\u001b[0m`)
        return
      }
    },
    startupmessage: function(client) {
        ...
        console.log(`\x1b[31m██║░░██╗██║░░██║██║╚██╔╝██║██╔═══╝░██║░░░░░██╔══╝░░░██╔██╗░`)
        console.log(`\x1b[31m╚█████╔╝╚█████╔╝██║░╚═╝░██║██║░░░░░███████╗███████╗██╔╝╚██╗`) 
        console.log(`\x1b[31m░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚═╝░░░░░╚══════╝╚══════╝╚═╝░░╚═╝ u001b[0mv${require(`${process.cwd()}/package.json`).version}\x1b[31m          \\/      `)
        console.log(`                                                     `)
        console.log(`\x1b[31m                   Created By NASH                   `)
        console.log(`\x1b[31m               Developed By NASH           `)
        console.log(`\u001b[0m`)
    },
