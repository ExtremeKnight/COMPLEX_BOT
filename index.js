...
if(nodeversion < 12){ // If the version is less than v12 then throw an error & attempt an update 
  mycatch = true
  console.log("\x1b[31mYou are using an outdated version of node! Please update to the version listed here: https://docs.Complex.net/Complex/dependencies.\u001b[0m")
  ...
  try{
    ...
    if(process.platform.includes("linux")){ // If linux, update for them
      ...
      try{
        ...
        console.log(`\x1b[32mYou should run the \x1b[33mwindows-install.bat \x1b[32mfile that comes with Complex.\u001b[0m`)
        console.log(`Join our Discord server if you need help! https://discord.Complex.net`)
      }
    }
    else{ // If not linux or windows, manually install them:
      console.log(`\x1b[31mDetected outdated dependencies!\u001b[0m`)
      console.log(`Check out https://docs.Complex.net/support/troubleshooting/updating-packages or https://discord.Complex.net for help.`)
    }
  }
}
const fs = require("fs")
